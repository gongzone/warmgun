...
<div class="grid grid-cols-1 gap-8 items-center md:gap-10 lg:grid-cols-2">
	<div class="space-y-4 md:space-y-6 mx-auto lg:mx-0">
		...
		<div>
			<h2 class="font-heading-token !text-4xl min-[540px]:!text-6xl">당신의 개발 이야기</h2>
			<h3 class="font-heading-token !text-2xl min-[540px]:!text-4xl">기록하고 공유하세요</h3>
		</div>
	...
	<div class="relative max-w-[640px] mx-auto">
		...
		{#each topUsers as { id, username, profile, _count }, index (id)}
			<div
