...
<div class="relative flex flex-col items-center px-4 pt-6 md:pt-0 pb-12">
	<ul class="overflow-x-auto mb-6">
		<li class="inline-block mb-2 mr-1">
			<a href="/" class="btn btn-sm md:btn-lg variant-ringed-surface py-3 font-logo">Frontend</a>
		</li>
		<li class="inline-block mb-2 mr-1">
			<a href="/" class="btn btn-sm md:btn-lg variant-ringed-surface py-3 font-logo">Backend</a>
		</li>
		<li class="inline-block mb-2 mr-1">
			<a href="/" class="btn btn-sm md:btn-lg variant-ringed-surface py-3 font-logo">Dev-Ops</a>
		</li>
		<li class="inline-block mb-2 mr-1">
			<a href="/" class="btn btn-sm md:btn-lg variant-ringed-surface py-3 font-logo">Mobile</a>
		</li>
		<li class="inline-block mb-2 mr-1">
			<a href="/" class="btn btn-sm md:btn-lg variant-ringed-surface py-3 font-logo">Game</a>
		</li>
		<li class="inline-block mb-2 mr-1">
